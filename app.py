        ...
        try:
            ...
            for key, val in predict_dict.items():
                for key2, val2 in val.items():
                    ...
                    elif val[key2]['prediction'] == 'active' and (key2 == 'sigma1RFP' or key2 == 'sigma1RTopo' or key2 == 'sigma1RDes'):
                        proba_1 = float(val[key2]['probability'])
                        proba_0 = round(1 - proba_1, 2)
                        sigma1r_proba_1.append(proba_1)
                        sigma1r_proba_0.append(proba_0)
                        predict_dict[key][key2].update({'predict_proba_0': str(proba_0)})
                        predict_dict[key][key2].update({'predict_proba_1': str(proba_1)})
                        predict_dict[key][key2].update({'prediction': 'ACTIVE'})
                        sigma1r_labels.append(val[key2]['prediction'])
                        continue

                    elif val[key2]['prediction'] == 'inactive' and (key2 == 'sigma1RFP' or key2 == 'sigma1RTopo' or key2 == 'sigma1RDes'):
                        proba_0 = float(val[key2]['probability'])
                        proba_1 = round(1 - proba_0, 2)
                        sigma1r_proba_1.append(proba_1)
                        sigma1r_proba_0.append(proba_0)
            ...
            consensus_prediction_results[processed_smiles]['sigma1R Model'] = {'prediction': max(sigma1r_labels, key=sigma1r_labels.count)}
            ...
            if consensus_prediction_results[processed_smiles]['sigma1R Model']['prediction'] == 'INACTIVE':
                consensus_prediction_results[processed_smiles]['sigma1R Model'].update({'probability': str(round(sum(sigma1r_proba_0) / 3, 2))})

            if consensus_prediction_results[processed_smiles]['sigma1R Model']['prediction'] == 'ACTIVE':
                consensus_prediction_results[processed_smiles]['sigma1R Model'].update({'probability': str(round(sum(sigma1r_proba_1) / 3, 2))})
            ...
            try:
                if synonyms =='-':
                    synonyms_modified = '-'+'|'+'-'
                elif drug_central_name!='-' and synonyms !='-':
            ...
            all_dict['sigma1R_prediction'] = consensus_prediction_results[processed_smiles]['sigma1R Model']['prediction']
            all_dict['sigma1R_probability'] = consensus_prediction_results[processed_smiles]['sigma1R Model']['probability']

            all_dict['error'] = {'message': "NO ERROR", 'error': 'None'}
            all_dict['error_flag'] = 'FALSE'

            all_dict['ActDes_model'] = predict_dict[processed_smiles]['ActDes']['model']
            all_dict['ActDes_probability'] = predict_dict[processed_smiles]['ActDes']['probability']
            all_dict['ActDes_prediction'] = predict_dict[processed_smiles]['ActDes']['prediction']
            all_dict['ActFP_model'] = predict_dict[processed_smiles]['ActFP']['model']
            all_dict['ActFP_probability'] = predict_dict[processed_smiles]['ActFP']['probability']
            all_dict['ActFP_prediction'] = predict_dict[processed_smiles]['ActFP']['prediction']
            all_dict['ActTopo_model'] = predict_dict[processed_smiles]['ActTopo']['model']
            all_dict['ActTopo_probability'] = predict_dict[processed_smiles]['ActTopo']['probability']
            all_dict['ActTopo_prediction'] = predict_dict[processed_smiles]['ActTopo']['prediction']

            all_dict['ToxDes_model'] = predict_dict[processed_smiles]['ToxDes']['model']
            all_dict['ToxDes_probability'] = predict_dict[processed_smiles]['ToxDes']['probability']
            all_dict['ToxDes_prediction'] = predict_dict[processed_smiles]['ToxDes']['prediction']
            all_dict['ToxFP_model'] = predict_dict[processed_smiles]['ToxFP']['model']
            all_dict['ToxFP_probability'] = predict_dict[processed_smiles]['ToxFP']['probability']
            all_dict['ToxFP_prediction'] = predict_dict[processed_smiles]['ToxFP']['prediction']
            all_dict['ToxTopo_model'] = predict_dict[processed_smiles]['ToxTopo']['model']
            all_dict['ToxTopo_probability'] = predict_dict[processed_smiles]['ToxTopo']['probability']
            all_dict['ToxTopo_prediction'] = predict_dict[processed_smiles]['ToxTopo']['prediction']

            all_dict['AlphaLisaDes_model'] = predict_dict[processed_smiles]['AlphaLisaDes']['model']
            all_dict['AlphaLisaDes_probability'] = predict_dict[processed_smiles]['AlphaLisaDes']['probability']
            all_dict['AlphaLisaDes_prediction'] = predict_dict[processed_smiles]['AlphaLisaDes']['prediction']
            all_dict['AlphaLisaFP_model'] = predict_dict[processed_smiles]['AlphaLisaFP']['model']
            all_dict['AlphaLisaFP_probability'] = predict_dict[processed_smiles]['AlphaLisaFP']['probability']
            all_dict['AlphaLisaFP_prediction'] = predict_dict[processed_smiles]['AlphaLisaFP']['prediction']
            all_dict['AlphaLisaTopo_model'] = predict_dict[processed_smiles]['AlphaLisaTopo']['model']
            all_dict['AlphaLisaTopo_probability'] = predict_dict[processed_smiles]['AlphaLisaTopo']['probability']
            all_dict['AlphaLisaTopo_prediction'] = predict_dict[processed_smiles]['AlphaLisaTopo']['prediction']

            all_dict['TruHitDes_model'] = predict_dict[processed_smiles]['TruHitDes']['model']
            all_dict['TruHitDes_probability'] = predict_dict[processed_smiles]['TruHitDes']['probability']
            all_dict['TruHitDes_prediction'] = predict_dict[processed_smiles]['TruHitDes']['prediction']
            all_dict['TruHitFP_model'] = predict_dict[processed_smiles]['TruHitFP']['model']
            all_dict['TruHitFP_probability'] = predict_dict[processed_smiles]['TruHitFP']['probability']
            all_dict['TruHitFP_prediction'] = predict_dict[processed_smiles]['TruHitFP']['prediction']
            all_dict['TruHitTopo_model'] = predict_dict[processed_smiles]['TruHitTopo']['model']
            all_dict['TruHitTopo_probability'] = predict_dict[processed_smiles]['TruHitTopo']['probability']
            all_dict['TruHitTopo_prediction'] = predict_dict[processed_smiles]['TruHitTopo']['prediction']

            all_dict['ACE2EnzymaticDes_model'] = predict_dict[processed_smiles]['ACE2EnzymaticDes']['model']
            all_dict['ACE2EnzymaticDes_probability'] = predict_dict[processed_smiles]['ACE2EnzymaticDes']['probability']
            all_dict['ACE2EnzymaticDes_prediction'] = predict_dict[processed_smiles]['ACE2EnzymaticDes']['prediction']
            all_dict['ACE2EnzymaticFP_model'] = predict_dict[processed_smiles]['ACE2EnzymaticFP']['model']
            all_dict['ACE2EnzymaticFP_probability'] = predict_dict[processed_smiles]['ACE2EnzymaticFP']['probability']
            all_dict['ACE2EnzymaticFP_prediction'] = predict_dict[processed_smiles]['ACE2EnzymaticFP']['prediction']
            all_dict['ACE2EnzymaticTopo_model'] = predict_dict[processed_smiles]['ACE2EnzymaticTopo']['model']
            all_dict['ACE2EnzymaticTopo_probability'] = predict_dict[processed_smiles]['ACE2EnzymaticTopo']['probability']
            all_dict['ACE2EnzymaticTopo_prediction'] = predict_dict[processed_smiles]['ACE2EnzymaticTopo']['prediction']

            all_dict['3CLEnzymaticDes_model'] = predict_dict[processed_smiles]['3CLEnzymaticDes']['model']
            all_dict['3CLEnzymaticDes_probability'] = predict_dict[processed_smiles]['3CLEnzymaticDes']['probability']
            all_dict['3CLEnzymaticDes_prediction'] = predict_dict[processed_smiles]['3CLEnzymaticDes']['prediction']
            all_dict['3CLEnzymaticFP_model'] = predict_dict[processed_smiles]['3CLEnzymaticFP']['model']
            all_dict['3CLEnzymaticFP_prediction'] = predict_dict[processed_smiles]['3CLEnzymaticFP']['prediction']
            all_dict['3CLEnzymaticFP_probability'] = predict_dict[processed_smiles]['3CLEnzymaticFP']['probability']
            all_dict['3CLEnzymaticTopo_model'] = predict_dict[processed_smiles]['3CLEnzymaticTopo']['model']
            all_dict['3CLEnzymaticTopo_probability'] = predict_dict[processed_smiles]['3CLEnzymaticTopo']['probability']
            all_dict['3CLEnzymaticTopo_prediction'] = predict_dict[processed_smiles]['3CLEnzymaticTopo']['prediction']

            all_dict['CoVPPEDes_model'] = predict_dict[processed_smiles]['CoVPPEDes']['model']
            all_dict['CoVPPEDes_probability'] = predict_dict[processed_smiles]['CoVPPEDes']['probability']
            all_dict['CoVPPEDes_prediction'] = predict_dict[processed_smiles]['CoVPPEDes']['prediction']
            all_dict['CoVPPEFP_model'] = predict_dict[processed_smiles]['CoVPPEFP']['model']
            all_dict['CoVPPEFP_probability'] = predict_dict[processed_smiles]['CoVPPEFP']['probability']
            all_dict['CoVPPEFP_prediction'] = predict_dict[processed_smiles]['CoVPPEFP']['prediction']
            all_dict['CoVPPETopo_model'] = predict_dict[processed_smiles]['CoVPPETopo']['model']
            all_dict['CoVPPETopo_probability'] = predict_dict[processed_smiles]['CoVPPETopo']['probability']
            all_dict['CoVPPETopo_prediction'] = predict_dict[processed_smiles]['CoVPPETopo']['prediction']
            
            all_dict['CoVPPEcsDes_model'] = predict_dict[processed_smiles]['CoVPPEcsDes']['model']
            all_dict['CoVPPEcsDes_probability'] = predict_dict[processed_smiles]['CoVPPEcsDes']['probability']
            all_dict['CoVPPEcsDes_prediction'] = predict_dict[processed_smiles]['CoVPPEDes']['prediction']
            all_dict['CoVPPEcsFP_model'] = predict_dict[processed_smiles]['CoVPPEcsFP']['model']
            all_dict['CoVPPEcsFP_probability'] = predict_dict[processed_smiles]['CoVPPEcsFP']['probability']
            all_dict['CoVPPEcsFP_prediction'] = predict_dict[processed_smiles]['CoVPPEcsFP']['prediction']
            all_dict['CoVPPEcsTopo_model'] = predict_dict[processed_smiles]['CoVPPEcsTopo']['model']
            all_dict['CoVPPEcsTopo_probability'] = predict_dict[processed_smiles]['CoVPPEcsTopo']['probability']
            all_dict['CoVPPEcsTopo_prediction'] = predict_dict[processed_smiles]['CoVPPEcsTopo']['prediction']

            all_dict['MERSPPEDes_model'] = predict_dict[processed_smiles]['MERSPPEDes']['model']
            all_dict['MERSPPEDes_probability'] = predict_dict[processed_smiles]['MERSPPEDes']['probability']
            all_dict['MERSPPEDes_prediction'] = predict_dict[processed_smiles]['MERSPPEDes']['prediction']
            all_dict['MERSPPEFP_model'] = predict_dict[processed_smiles]['MERSPPEFP']['model']
            all_dict['MERSPPEFP_probability'] = predict_dict[processed_smiles]['MERSPPEFP']['probability']
            all_dict['MERSPPEFP_prediction'] = predict_dict[processed_smiles]['MERSPPEFP']['prediction']
            all_dict['MERSPPETopo_model'] = predict_dict[processed_smiles]['MERSPPETopo']['model']
            all_dict['MERSPPETopo_probability'] = predict_dict[processed_smiles]['MERSPPETopo']['probability']
            all_dict['MERSPPETopo_prediction'] = predict_dict[processed_smiles]['MERSPPETopo']['prediction']

            all_dict['MERSPPEcsDes_model'] = predict_dict[processed_smiles]['MERSPPEcsDes']['model']
            all_dict['MERSPPEcsDes_probability'] = predict_dict[processed_smiles]['MERSPPEcsDes']['probability']
            all_dict['MERSPPEcsDes_prediction'] = predict_dict[processed_smiles]['MERSPPEcsDes']['prediction']
            all_dict['MERSPPEcsFP_model'] = predict_dict[processed_smiles]['MERSPPEcsFP']['model']
            all_dict['MERSPPEcsFP_probability'] = predict_dict[processed_smiles]['MERSPPEcsFP']['probability']
            all_dict['MERSPPEcsFP_prediction'] = predict_dict[processed_smiles]['MERSPPEcsFP']['prediction']
            all_dict['MERSPPEcsTopo_model'] = predict_dict[processed_smiles]['MERSPPEcsTopo']['model']
            all_dict['MERSPPEcsTopo_probability'] = predict_dict[processed_smiles]['MERSPPEcsTopo']['probability']
            all_dict['MERSPPEcsTopo_prediction'] = predict_dict[processed_smiles]['MERSPPEcsTopo']['prediction']

            all_dict['hCYTOXDes_model'] = predict_dict[processed_smiles]['hCYTOXDes']['model']
            all_dict['hCYTOXDes_probability'] = predict_dict[processed_smiles]['hCYTOXDes']['probability']
            all_dict['hCYTOXDes_prediction'] = predict_dict[processed_smiles]['hCYTOXDes']['prediction']
            all_dict['hCYTOXFP_model'] = predict_dict[processed_smiles]['hCYTOXFP']['model']
            all_dict['hCYTOXFP_probability'] = predict_dict[processed_smiles]['hCYTOXFP']['probability']
            all_dict['hCYTOXFP_prediction'] = predict_dict[processed_smiles]['hCYTOXFP']['prediction']
            all_dict['hCYTOXTopo_model'] = predict_dict[processed_smiles]['hCYTOXTopo']['model']
            all_dict['hCYTOXTopo_probability'] = predict_dict[processed_smiles]['hCYTOXTopo']['probability']
            all_dict['hCYTOXTopo_prediction'] = predict_dict[processed_smiles]['hCYTOXTopo']['prediction']

            all_dict['sigma1RDes_model'] = predict_dict[processed_smiles]['sigma1RDes']['model']
            all_dict['sigma1RDes_probability'] = predict_dict[processed_smiles]['sigma1RDes']['probability']
            all_dict['sigma1RDes_prediction'] = predict_dict[processed_smiles]['sigma1RDes']['prediction']
            all_dict['sigma1RFP_model'] = predict_dict[processed_smiles]['sigma1RFP']['model']
            all_dict['sigma1RFP_probability'] = predict_dict[processed_smiles]['sigma1RFP']['probability']
            all_dict['sigma1RFP_prediction'] = predict_dict[processed_smiles]['sigma1RFP']['prediction']
            all_dict['sigma1RTopo_model'] = predict_dict[processed_smiles]['sigma1RTopo']['model']
            all_dict['sigma1RTopo_probability'] = predict_dict[processed_smiles]['sigma1RTopo']['probability']
            all_dict['sigma1RTopo_prediction'] = predict_dict[processed_smiles]['sigma1RTopo']['prediction']

        except Exception as e:
            all_dict['error'] = {'message': "SCRIPT ERROR", 'error': str(e)}
            all_dict['error_flag'] = 'TRUE'
            #print('All_dict', all_dict) # Ap9
